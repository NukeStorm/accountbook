...
class MainView extends View {
  constructor() {
    const componentList = [new MonthSelector('#monthSelector'), new MenuBar('#menu-bar'), new ContentAddForm('#content-add-form'), new CategoryFilter('#category-type-filter'), new HistoryList('#history-list')];
